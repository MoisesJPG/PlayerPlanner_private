...
export class CharacterDataElementTalentMaterials {
	...
	/** @type {InventoryMat[]} **/ 2 = [{ item: Items.MORA.getData().basename, amount: 12500 }];
	/** @type {InventoryMat[]} **/ 3 = [{ item: Items.MORA.getData().basename, amount: 17500 }];
	/** @type {InventoryMat[]} **/ 4 = [{ item: Items.MORA.getData().basename, amount: 25500 }];
	/** @type {InventoryMat[]} **/ 5 = [{ item: Items.MORA.getData().basename, amount: 30000 }];
	/** @type {InventoryMat[]} **/ 6 = [{ item: Items.MORA.getData().basename, amount: 37500 }];
	/** @type {InventoryMat[]} **/ 7 = [{ item: Items.MORA.getData().basename, amount: 120000 }];
	/** @type {InventoryMat[]} **/ 8 = [{ item: Items.MORA.getData().basename, amount: 260000 }];
	/** @type {InventoryMat[]} **/ 9 = [{ item: Items.MORA.getData().basename, amount: 450000 }];
	/** @type {InventoryMat[]} **/ 10 = [{ item: Items.MORA.getData().basename, amount: 700000 }, { item: Items.CROWN_OF_INSIGHT.getData().basename, amount: 1 }];
